package com.jordyf15.storyapp.ui.camera
...
import com.jordyf15.storyapp.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun takePhoto() {
        ...
        val photoFile = Utils.createdFile(application)
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                ...
                Toast.makeText(
                    this@CameraActivity,
                    getString(R.string.failed_camera_open),
                    Toast.LENGTH_SHORT
                ).show()
            }
        }, ContextCompat.getMainExecutor(this))
